...
python unit_eval.py --root-dir ./acdc_train --mode baseline --thres 0.1 --operation neighbor_dice --patient-id 1
python unit_eval.py --root-dir ./acdc_train --mode baseline --thres 0.2 --operation neighbor_dice --patient-id 1
python unit_eval.py --root-dir ./acdc_train --mode baseline --thres 0.3 --operation neighbor_dice --patient-id 1
python unit_eval.py --root-dir ./acdc_train --mode baseline --thres 0.4 --operation neighbor_dice --patient-id 1
python unit_eval.py --root-dir ./acdc_train --mode baseline --thres 0.5 --operation neighbor_dice --patient-id 1
python unit_eval.py --root-dir ./acdc_train --mode baseline --thres 0.6 --operation neighbor_dice --patient-id 1
python unit_eval.py --root-dir ./acdc_train --mode baseline --thres 0.7 --operation neighbor_dice --patient-id 1
python unit_eval.py --root-dir ./acdc_train --mode baseline --thres 0.8 --operation neighbor_dice --patient-id 1
python unit_eval.py --root-dir ./acdc_train --mode baseline --thres 0.9 --operation neighbor_dice --patient-id 1
python unit_eval.py --root-dir ./acdc_train --mode self_derived_prompts --operation neighbor_dice --patient-id 1
python unit_eval.py --root-dir ./acdc_train --mode annotation_derived_prompts --operation neighbor_dice --patient-id 1